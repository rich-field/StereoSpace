...
n1 = Note.create(:point_in_segment => 20, :sample_path => 'y' )
n2 = Note.create(:point_in_segment => 90, :sample_path => 'semicolon' )
n3 = Note.create(:point_in_segment => 50, :sample_path => 'slash' )
s1_1.notes << n1 << n2
s1_2.notes << n3
